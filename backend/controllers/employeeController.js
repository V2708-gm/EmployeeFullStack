...
exports.createEmployee = async (req, res, next) => {
  console.log("Call for create employee");
  try {
...
exports.getAllEmployees = async (req, res, next) => {
  try {
    ...
    await req.redis.set(key, JSON.stringify(employees), 'EX', 60);
...
exports.updateEmployee = async (req, res, next) => {
  try {
    ...
    await req.redis.publish('employee-updated', JSON.stringify(employee));
...
exports.deleteEmployee = async (req, res, next) => {
  try {
    ...
    await req.redis.publish('employee-deleted', JSON.stringify({ id: req.params.id }));
